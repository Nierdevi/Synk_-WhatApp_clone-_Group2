...
const UpdatesScreen = ({ navigation }) => {
    ...
    const suggestedChannels = [
        ...
        { id: 5, name: 'BBC News', img: 'https://pbs.twimg.com/profile_images/1529107170448523264/q3VwEx38_400x400.jpg', followers: '900 followers' },
        ...
        const fetchChannels = async () => {
            try {
                ...
                const bbcChannel = {
                    ...
                    img: 'https://pbs.twimg.com/profile_images/1529107170448523264/q3VwEx38_400x400.jpg',
        ...
        <Provider>
            <View style={styles.container}>
                ...
                >
                    ...
                    <Divider />
                    <Menu.Item onPress={() => navigation.navigate('SettingsScreen')} title="Settings" />
                </Menu>
            </View>
        </Provider>
    );
