    ...
    const handleChooseImage = () => {
        ...
        ImagePicker.showImagePicker(options, response => {
            if (response.didCancel) {
                ...
                // Update statuses state to add the selected image
                setStatuses(prevStatuses => [
                    ...prevStatuses,
                    { id: prevStatuses.length + 1, user: 'Me', img: source.uri, total: 1, viewed: 0 }
                ]);
            }
        });
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.bottomRightIcons}>
                ...
                {/* Camera icon below */}
                <TouchableOpacity style={styles.bottomIcon} onPress={handleChooseImage}>
